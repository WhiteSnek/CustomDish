...
const addAddress = asyncHandler( async(req,res) => {
    ...
    return res.status(200).json(new ApiResponse(200, response, "Address added successfully"))
})
...
const addOrder = asyncHandler( async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,addOrder,"Order added successfully!"))
})
...
const getOrders = asyncHandler( async(req,res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200,user[0].order, "Orders fetched successfully")
    )
